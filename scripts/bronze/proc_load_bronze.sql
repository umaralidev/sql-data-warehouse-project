...
Purpose:
    ...
    - Clears existing data in bronze tables using TRUNCATE.
    - Loads new data from CSV files into bronze tables using BULK INSERT.

Parameters:
    None. 
    This procedure does not take any input or return anything.
